							...
							<div class="col-xs-12">
								<div class="wrap-breadcrumb clearfix">
									<ol class="breadcrumb">
										...
										<li><a href="javascript:void(0);">Edit Page</a></li>
									</ol>
								</div>
							</div>
						</div><!-- end row -->
...
<?php echo isset($item)?form_open('myadmin/edit_page'):form_open('myadmin/create_page')?>
    ...
    <textarea name="body" class="form-control" rows="15" ><?php echo isset($item)?$item['body']:""; ?></textarea><br />
	<?php if(isset($item)){ ?>
   <input type="hidden" name="id" value="<?php echo $item['id']; ?>" />
   <?php } ?>
    <input type="submit" style="float:right" class="btn btn-primary btn-effect" name="<?php echo isset($item)?"create_item":"save_item"; ?>" value="<?php echo isset($item)?"Save page":"Create page"; ?>" />
	 <input type="submit" name="preview" class="btn btn-warning btn-effect" style="float:right; margin-right:15px" value="Preview" />
</form>
</div>
</div>
</div>
