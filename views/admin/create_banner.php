							...
							<div class="col-xs-12">
								<div class="wrap-breadcrumb clearfix">
									<ol class="breadcrumb">
										...
										<li><a href="<?php echo $this->config->config['base_url']?>myadmin/banners">Banners</a></li>
										<li><a href="javascript:void(0);"><?php echo (isset($item))?"Edit Banner":"Create Banner"; ?></a></li>
									</ol>
								</div>
							</div>
						</div><!-- end row -->
...
<?php echo isset($item['id']) ?form_open_multipart('myadmin/edit_banner/'.$id.''):form_open_multipart('myadmin/create_banner')?>
   ...
   <?php if(isset($item)){ ?>
   <img src="<?php echo $item['url']; ?>" style="width:100%; height:80%" /><br/>
   <?php } ?>
